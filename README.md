...
*   **Двухпанельный интерфейс**: Удобное управление локальными и удаленными файлами в одном окне.
*   **Подключение к FTP-серверу**: Поддержка стандартных FTP-подключений с указанием хоста, логина и пароля.
*   **Управление файлами**: Загрузка (Upload), скачивание (Download), создание папок, переименование и удаление файлов и папок.
*   **Рредактирование**: Возможность редактирования файлов типа ".txt", ".json", ".xml", ".log".
*   **Отслеживание прогресса**: Индикация прогресса для операций загрузки и скачивания файлов.
*   **Логирование операций**: Лог команд и ответов сервера для отладки и контроля.
